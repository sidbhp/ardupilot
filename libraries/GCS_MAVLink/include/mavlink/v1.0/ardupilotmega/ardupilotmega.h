...
typedef enum MAV_CMD
{
	...
	MAV_CMD_SOLO_BTN_FLY_CLICK=42001, /* Set mode to LOITER, if that fails set mode to ALT_HOLD. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
	MAV_CMD_SOLO_BTN_FLY_HOLD=42002, /* If disarmed, arm, else if armed and landed, take off, else if flying, land |Takeoff altitude| Empty| Empty| Empty| Empty| Empty| Empty|  */
