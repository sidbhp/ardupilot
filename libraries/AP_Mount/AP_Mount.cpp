...
void AP_Mount::init(DataFlash_Class *dataflash, const AP_SerialManager& serial_manager, AP_AccelCal &acal)
{
    ...
    for (uint8_t instance=0; instance<AP_MOUNT_MAX_INSTANCES; instance++) {
        ...
        // check for MAVLink mounts
            ...
            _backends[instance] = new AP_Mount_MAVLink(*this, state[instance], instance, acal);
            _num_instances++;
#endif
