...
#!/usr/bin/env python
'''
these tables are generated from the STM32 datasheet for the
STM32F413
'''
...
AltFunction_map = {
	...
	# extracted from tabula-AF-F413xH.csv
	"PA0:EVENTOUT"      	:	15,
	"PA0:TIM2_CH1"      	:	1,
	"PA0:TIM2_ETR"      	:	1,
	"PA0:TIM5_CH1"      	:	2,
