...
QFLIGHT_CAMERA_SRC = $(SKETCHBOOK)/libraries/AP_HAL_Linux/qflight_camera/libcamera/src
QFLIGHT_BUILD	 = $(BUILDROOT)/libraries/AP_HAL_Linux/qflight
QFLIGHT_LIB = /opt/qrlsdk/sysroots/eagle8074/usr/lib/
...
QCAM_INC = -I$(SKETCHBOOK)/libraries/AP_HAL_Linux/qflight_camera/libcamera/inc -I$(SKETCHBOOK)/libraries/AP_HAL_Linux/qflight_camera/libcamera/src
ARM_INC= $(QCAM_INC) -I$(HEXAGON_SDK_ROOT)/lib/common/remote/ship/UbuntuARM_Debug -I$(HEXAGON_SDK_ROOT)/lib/common/rpcmem/UbuntuARM_Debug/ship -I$(HEXAGON_SDK_ROOT)/inc/stddef -I$(BUILDROOT)/libraries -I$(HEXAGON_SDK_ROOT)/inc/stddef
...
$(BUILDROOT)/libraries/AP_HAL_Linux/qflight/%.o: $(BUILDROOT)/libraries/AP_HAL_Linux/qflight/%.c
	$(RULEHDR)
	$(v)$(CC) -c -fPIC -mword-relocations -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a8 -march=armv7-a -g -O3 -fno-strict-aliasing -DARM_ARCH_7A -DUSE_SYSLOG -I$(HEXAGON_SDK_ROOT)/inc/stddef $(QCAM_INC) -I$(HEXAGON_SDK_ROOT)/lib/common/adspmsgd/ship/UbuntuARM_Debug -I$(HEXAGON_SDK_ROOT)/lib/common/rpcmem/UbuntuARM_Debug/ship -I$(HEXAGON_SDK_ROOT)/lib/common/rpcmem/UbuntuARM_Debug/ship -I$(HEXAGON_SDK_ROOT)/lib/common/remote/ship/UbuntuARM_Debug -std=gnu99 -o $@ $<
...
$(SKETCHELF): $(SKETCHOBJS) $(LIBOBJS)
	...
	$(RULEHDR)
	$(v)$(QFLIGHT_CC) $(QCAM_INC) -march=armv7-a -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a8 -Wl,-unresolved-symbols=ignore-in-shared-libs -Wl,-ldl -o $@ -Wl,"-(" $(SKETCHOBJS) $(LIBOBJS) -L$(QFLIGHT_LIB)  -lcamparams -lcamera -L$(HEXAGON_SDK_ROOT)/lib/common/remote/ship/UbuntuARM_Debug/ -ladsprpc -lpthread $(HEXAGON_SDK_ROOT)/lib/common/rpcmem/UbuntuARM_Debug/ship/rpcmem.a $(HEXAGON_SDK_ROOT)/lib/common/adspmsgd/ship/UbuntuARM_Debug/adspmsgd.a -Wl,"-)" -lm -lc -lsupc++ -lgcc_eh -lgcc -lpthread -lstdc++
