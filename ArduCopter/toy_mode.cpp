...
const AP_Param::GroupInfo ToyMode::var_info[] = {
    ...
    AP_SUBGROUPINFO(_var_info_profile[0], "_P1_", 19, ToyMode, ToyMode::Profile),

    // @Group: _P1
    // @Description: Profile set 2
    AP_SUBGROUPINFO(_var_info_profile[1], "_P2_", 20, ToyMode, ToyMode::Profile),

    // @Group: _P1
    // @Description: Profile set 3
    AP_SUBGROUPINFO(_var_info_profile[2], "_P3_", 21, ToyMode, ToyMode::Profile),

    // @Group: _P1
    // @Description: Profile set 4
    AP_SUBGROUPINFO(_var_info_profile[3], "_P4_", 22, ToyMode, ToyMode::Profile),
